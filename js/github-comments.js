    ...
    $.ajax({
        ...
        success: function(comments, textStatus, jqXHR) {
            ...
            if (1 == page_id) {
                ...
                $("#gh-comments-list").append("<form action='" + url + "' rel='nofollow'> <button type='submit' class='btn-social btn-github' value=' Post a comment on Github' /> </button> </form>");
            }
            ...
            $.each(comments, function(i, comment) {
                ...
                t += "<img src='" + comment.user.avatar_url + "' width='24px'; padding='10px'>";
